      ...
      <div className="mt-14 rounded-lg p-4 dark:border-gray-700">
        ...
        <div className="relative overflow-x-auto">
          <div className="flex flex-wrap items-center justify-around space-y-4 bg-white py-4 md:flex-row md:space-y-0 dark:bg-gray-900">
            ...
            <button className="mb-2 me-2 rounded-lg bg-gradient-to-r from-green-400 via-green-500 to-green-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gradient-to-br focus:outline-none focus:ring-4 focus:ring-green-300 dark:focus:ring-green-800">
              Add Order
            </button>
          </div>
        </div>
