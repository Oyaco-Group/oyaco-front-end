      ...
      <div className="h-full overflow-y-auto bg-white px-3 pb-4 dark:bg-gray-800">
        <ul className="space-y-2 font-medium">
          ...
          <li>
            <a
              href="#"
              className="group flex items-center rounded-lg p-2 font-bold text-red-800 hover:bg-blue-100"
            >
              <svg
                className="h-5 w-5 flex-shrink-0 text-red-800 transition duration-75 group-hover:text-red-800"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 20 20"
